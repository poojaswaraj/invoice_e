...
<div class="row">
	...
	<div class="col-lg-9">
		...
		<div class="col-md-3">
			<input type="text" class="form-control" name="invoice_no" value="<?php echo $data['invoice_no'];?>" id="invoice_no" placeholder="Invoice No">
		</div>

		<div class="col-md-3">
			<input type="text" class="form-control" name="voucher_no" value="<?php echo $data['voucher_no'];?>" id="voucher_no" placeholder="Voucher No" required="">
		</div>
		
		<div class="col-md-3">
			<input type="text" class="form-control" name="txt_client" value="<?php echo $data['proj_client'];?>" id="txt_client" placeholder="Project/Client" >
		</div>
    ...
    padding: 5px 9px;"> <span class="icon fa fa-caret-down"></span></button>
      ...
      <div class="btn-group col-md-3" >
       <?php 
	     ...
	     ?>
        <input type="text" readonly name="select_tax" id="select_tax" placeholder="Tax Percentage" value="<?php echo $data['tax_value'];?>" maxlength="6" class="form-control" <?php if(!empty($defrow['value'])) { echo "readonly=\"readonly\""; } ?> onkeyup="taxoncalculation();" onkeypress="return onlyNos(event,this);" style="margin-left: -10px; width: 127px;"/>
       ...
       <input type="hidden" class="form-control" name="tax_amt" id="tax_amt" placeholder="Tax Amount " onkeyup="taxoncalculation();">
		...
		<div class="col-md-3">
			<input type="text" class="form-control" name="total_amt" id="total_amt" value="<?php echo $data['total_amt'];?>" placeholder="Amount">
		</div>
		<div class="panel-body"></div>
		...
		<div class="col-md-3">
			<input type="date" class="form-control" name="cheque_dt" id="cheque_dt" value="<?php echo $data['cheque_date'];?>" placeholder="Cheque Date">
		</div>
		<div class="panel-body"></div>
		<div class="col-md-10">
