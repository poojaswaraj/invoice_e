...
<div class="col-lg-9">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="email" class="form-control" name="txt_cemail" id="txt_cemail" value="<?php if(isset($_GET["id"])){ echo $data['customer_email'];} else {}?>" placeholder="Client Email Address" required="">
		</div>
