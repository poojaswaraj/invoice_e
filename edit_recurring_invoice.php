...
<div class="col-lg-9">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_state" id="txt_state" value="<?php if(isset($_GET["id"])){ echo $data['invoice_state'];} else {}?>" placeholder="State"  onkeyup="state()" >
		</div>
