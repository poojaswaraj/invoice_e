...
<div class="panel-body">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#payment" data-toggle="tab">Payment Gatway</a></li>
        <?php 
	 	...
	 	<div class="tab-pane fade" id="modues">
           ...
           <div class="col-md-6">
			...
			<ul>
				...
				<li><input type="checkbox" name="sales" id="sales" >&nbsp;Sales Module </li>
				<li><input type="checkbox" name="director" id="director" disabled="">&nbsp;Director Module </li>
    ...
    <!-- Tab 66 -->
        <div class="tab-pane fade" id="payment">
            <h3>Payment Gatway</h3><hr>
            <form id="mypaymet" name="mypaymet" autocomplete="off" method="POST" >
            	<input type="hidden" name="data" id="data" value="<?php echo $_SESSION['login_user']; ?>">
            ...
            <div class="col-lg-6">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="salt_key" id="salt_key" value="" placeholder="Salt Key" required>
				</div>
				<div class="panel-body"></div>
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="marchent_id" id="marchent_id" value="" placeholder="Marchent Id" required>
				</div>
				<div class="panel-body"></div>
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="customer_id" id="customer_id" value="" placeholder="Customer Id" required>
				</div>
				<div class="panel-body"></div>
			...
			<div class="col-lg-12" align="right">
				<!-- <button name="btn_save" type="submit" class="btn btn-primary">Save</button> -->
				<button name="" type="submit" class="btn btn-primary" id="" value="save">Save</button>
			</div>
			<center><p id="msg"></p></center>
			</form>
		</div>
